...
In Formularen können Optionen (z.B. Radio Buttons / Checkboxes) mit Preisen versehen werden. Für den Fall, dass eine Zahlung zwingend sein soll, wird dies in der Formular-Definition entsprechend markiert.

- Details und Beispiele: [Formulare – Preisangaben](/module/formulare/#preisangaben)

## Payment Gateway

Damit Zahlungen über das Portal abgewickelt werden können, muss ein Payment Gateway eingerichtet werden. Folgende Zahlungsanbieter stehen zur Verfügung:
